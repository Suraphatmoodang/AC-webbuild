...
export const PRODUCT_OPT = {
  ...
  type: [
    "เสื้อโปโล", "Sweather", "เสื้อ bomber jacket", "เสื้อเชิ้ต", "เสื้อแจ็กเก็ต", "เสื้อกล้าม",
